export const transactionsFixture003 = {
  data: {
    transactions: {
      pageInfo: {
        endCursor: 'MTc0MTgyMDA2MTo0MDA3MzU1Mw==',
        hasNextPage: false,
        hasPreviousPage: true,
        startCursor: 'MTc0MTgyMDExMTo0MDA3MzU0Nw==',
      },
      edges: [
        {
        ...
        {
          cursor: 'MTc0MTgyMDA3Mjo0MDA3MzU1Ng==',
          node: {
            ...
            cmd: {
              ...
              payload: {
                code: '"(free.radio02.add-received-with-chain \\"dca632fffee31095\\" \\"U2FsdGVkX1/YQzJB4P9j5yO2rW/ExKejaiMoWRYpCjg=;;;;;mv5n48vpLcD2afE4kqzBjmXJgr/XlIcYuO7ZazboqWDQ262CosafTQgY5Z1E4+ZsuzeU6osO5P4YZyx628zwqywfXfnZKKmS1AyffyAbbG8mmYT9+mlpwi/lf/q49vxRTyjzRYeO6LyUd3JIQZqEc6N1a3GkoUMPYEZ4TPuIwFQ=\\" \\"0\\" )"',
              },
            },
            result: {
              badResult: null,
        ...
        {
          cursor: 'MTc0MTgyMDA2MTo0MDA3MzU1Mw==',
          node: {
            ...
            cmd: {
              ...
              payload: {
                code: '"(free.radio02.update-sent \\"U2FsdGVkX1/DzuU0U1XEdXdnAdmZPWGkjwOVLPfeJE0=;;;;;UzNEWUohrNesEy+YH6tVuZPeFneSo1oHS158MrRQgZK9frJoD3OIA+GuQS1D4AECgx3+QJBBhECKxEnZeaorx00an2BGH0mhbD9Mc4rSU71E11544jNXvLJ7LLPP/zAPoXS8JHR9CWx6oLG+g0UTesg7nWb7YLijmk52fJ+qfDs=\\" )"',
              },
            },
            result: {
              badResult: null,
